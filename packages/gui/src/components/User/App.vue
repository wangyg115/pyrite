<template>
    <div
        class="c-user-app theme-dark" :class="{
    ...
    >
        <div class="presence">
            <header>
                <RouterLink
                    v-if="!$s.group.connected" class="logo"
                    :to="{name: 'main'}"
                >
                ...
                <RouterLink
                    class="btn tooltip btn-dashboard"
                    :class="{active: $route.name && $route.name.includes('dashboard')}"
